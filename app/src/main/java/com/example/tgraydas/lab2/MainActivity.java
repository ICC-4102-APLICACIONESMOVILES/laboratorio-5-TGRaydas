...
public class MainActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.formulario) {
            ...
            rl_login.setVisibility(View.GONE);
        } else if (id == R.id.login && !SeeIfLoged()) {
            rl_formulario.setVisibility(View.GONE);
            rl_list.setVisibility(View.GONE);
            rl_resume.setVisibility(View.GONE);
    ...
    public static void WriteSharedPreferences(Activity act, String email, String password){
